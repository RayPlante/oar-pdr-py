...
def update_nerdm_schema(nerdmd, version=None, byext={}):
    """
    NOTE: this function is DEPRECATED; use nistoar.nerdm.convert.latest
...
def create_release_history_for(pdrid):
    """
    NOTE: this function is DEPRECATED; use nistoar.nerdm.convert.latest.NERDm2Latest instead.
